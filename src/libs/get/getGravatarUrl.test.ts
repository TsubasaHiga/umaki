...
describe('getGravatarUrl', () => {
  it('should return correct Gravatar URL for a given email and size', () => {
    ...
    const expectedUrl = 'https://www.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0?s=80&d=404'
  ...
  it('should handle different email addresses correctly', () => {
    ...
    const expectedUrl = 'https://www.gravatar.com/avatar/640f8c96cd7de424a8248a15d8b19b4d?s=100&d=404'
    expect(result).toBe(expectedUrl)
  })
  ...
  it('should handle different sizes correctly', () => {
    ...
    const expectedUrl = 'https://www.gravatar.com/avatar/4b3cdf9adfc6258a102ab90eb64565ea?s=200&d=404'
    expect(result).toBe(expectedUrl)
  })
  ...
  it('should handle empty email correctly', () => {
    ...
    const expectedUrl = 'https://www.gravatar.com/avatar/d41d8cd98f00b204e9800998ecf8427e?s=80&d=404'
    expect(result).toBe(expectedUrl)
  })
  ...
  it('should handle email with uppercase letters correctly', () => {
    ...
    const expectedUrl = 'https://www.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0?s=150&d=404'
    expect(result).toBe(expectedUrl)
  })
